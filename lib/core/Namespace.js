    ...
    sorting(dataset){
        ...
        dataset.sort( (a, b)=>{
            ...
            if(a.isDeclaratorVariable){
                if(b.isDeclaratorVariable)return 0;
                return -1;
            }
            if(b.isDeclaratorVariable){
                if(a.isDeclaratorVariable)return 0;
                return 1;
            }
    ...
    clear( compilation ){
        ...
        this.modules.forEach( (module,key)=>{
            if(module.compilation === compilation){
                ...
                }else if(module.isDeclaratorTypeAlias || module.isTypeStatement){
                    Logger.print(`clear-type: ${module.value()}, file:${compilation.file}`, 'namespace')
                }
                this.del( key );
            }
        });
