    ...
    getContextOfInference(){
        ...
        if(this.isIdentifier){
            ...
            if(desc && desc !== this && this.is(desc)){
                return this.#inference = desc.getContextOfInference();
            }
        }
        ...
        }else if(this.isFunctionExpression && !this.parentStack.isMethodDefinition){
            let pp = this.parentStack;
            if(pp.isCallExpression || pp.isNewExpression){
                parent = pp.getContextOfInference();
            }
        }
        return this.#inference = Inference.create(this, parent);
    }
