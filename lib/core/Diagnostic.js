...
define(1188,"",[
    `对象属性(%s)的引用不明确，应该使用类型断言来约束`,
    `Refers object the '%s' property is ambiguous. should using type assertions to constraint`,
]);
...
define(1190,"",[
    ...
    `Refers object may be null should check the object is not null on before refers it or using optional-chain operator(?.) to gets the value of the '%s' property`,
]);
