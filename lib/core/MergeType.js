...
class MergeType{
    ...
    createGroup(stack){
        ...
        if( type.isLiteralObjectType ){
            ...
            dataset.#isLiteralArrayType = !!type.isLiteralArrayType;
        ...
        if(type){
            ...
            if( type.isLiteralValueType ){
                ...
                if( !group || !(group instanceof MergeType)){
                    group = new MergeType();
                    group.classGenericOriginType = type;
    ...
    type(){
        ...
        if( this.originType === origArrayType ){
            ...
            if(this.#isLiteralArrayType && this.keepLiteralArrayType){
               // return Utils.setMergedType(new LiteralArrayType(origArrayType, null, elements))
