                ...
                return forEach(declareType.elements, (decl,index)=>{
                    if( decl.isGenericType ){
                        ...
                        if(!declareType.prefix){
                            if(assignType.isTupleType && !declareType.prefix || assignType.isLiteralArrayType){
                        ...
                        if(decl.isTupleType){
                            ...
                            if(assign.elements[index]){
                                if(decl.prefix && !assign.prefix){
                                    ...
                                    if(!decl.prefix && decl.elements.length < assign.elements.length){
