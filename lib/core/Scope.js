...
module.exports = class Scope extends EventDispatcher{
    static is(value){
        return value ? value instanceof Scope : false;
    }
    constructor( parent ){
        super();
        this.parent = parent;
    ...
    setValidateState(descriptor, type, value, expr, block, isAlternate=false){
        this.validates.set(descriptor, {type, value, expr, scope:this, stack:block, isAlternate})
    }
