...
class InterfaceDeclaration extends Stack{
    constructor(compilation,node,scope,parentNode,parentStack){
        ...
        this.isInterfaceDecorator = !!node.decorator;
        this._metatypes = [];
        this._annotations = [];
        this.body    =[];
        this.usings  =[];
        ...
        module.isInterfaceDecorator = this.isInterfaceDecorator;
    ...
    async createCompleted(){
        ...
        const pushImp = (module, stack)=>{
            if(module && self !== module){
                if(!(module.isInterface || module.isDeclaratorModule || module.isStructTable)){
