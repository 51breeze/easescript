...
class ClassDeclaration extends Stack{
    ...
    async createCompleted(){
        ...
        await this.allSettled(this.imports,async(stack)=>await stack.addImport(this.module, this.scope));
    ...
    async parser(){
        return await this.callParser(async ()=>{
            ...
            await this.compilation.callHookAsync('class.body.parser.before');
