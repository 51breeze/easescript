      ...
      if( this.parentStack.source.isLiteral ){
         ...
         if(compilation){
            ...
            if(jsModule){
               ...
               // let desc = jsModule.get(this.imported.value());
               // if(desc)return desc;
               // if(jsModule.exports.size===1){
               //    desc = jsModule.exports.get('*');
               //    if(desc){
               //       const key = this.imported.value();
               //       if(desc.isExportAllDeclaration && JSModule.is(desc.module)){
               //          const object = desc.module;
               //          return object.getType(key) || object.getDescriptor(key);
               //       }
               ...
               //          if(object){
               //             if(this.is(desc)){
               //                return desc.getObjectDescriptor(object, key);
               //             }else{
               //                return this.getObjectDescriptor(object, key);
               //             }
               //          }
               //       }
               //    }
