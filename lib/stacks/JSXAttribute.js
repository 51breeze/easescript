        ...
        if( name ==="if" || name ==="elseif" ){
            ...
            if( this.value && this.value.isJSXExpressionContainer ){
                ...
                if( divide ){
                    ...
                    item = this.parserAttributeValueStack(this.compilation.source.substr(0,startAt+divide.index), startAt);
                    desc = this.parserAttributeValueStack(this.compilation.source.substr(0,startAt+value.length), startAt + divide.index + divide[0].length );
                }else{
                    if( name ==="each" ){
