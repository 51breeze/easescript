...
class MemberExpression extends Expression{
    ...
    getDescription(){
        ...
        if(Namespace.is(description)){
            ...
            if(!object){
                if(description.isExportAssignmentDeclaration){
                    ...
                    object = description;
                }else if(this.parentStack.isMemberExpression && JSModule.is(description.module)){
            ...
            if(object){
                if(this.parentStack.isMemberExpression){
                    ...
                    return object.getDescriptor(property);
                }
            }
        }
        ...
        const desc = this.getObjectDescriptor(objectType, property, isStatic);
        if(desc){
            return desc;
        }
    }
        ...
        return this.getAttribute('MemberExpression.descriptor', ()=>{
            ...
            if(_desc){
                if(this.parentStack.isNewExpression){
                    ...
                    let object = _desc.isNamespaceDeclaration ? _desc.parentStack.module : JSModule.is(_desc) ? _desc : _desc.module;
