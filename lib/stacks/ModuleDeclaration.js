...
class ModuleDeclaration extends Stack{
    constructor(compilation,node,scope,parentNode,parentStack){
        ...
        if(node.type==='NamespaceDeclaration'){
            ...
            if(this.id.isMemberExpression && parentStack.isNamespaceDeclaration){
                ...
                module = JSModule.createModuleFromNamespace(id, this.module, this.compilation);
    ...
    async createCompleted(){
        ...
        //         if(stack.isExportAllDeclaration && !stack.source){
        //             onlyOnceExport = stack;
        //             module.set('*', stack);
        //         }else{
        ...
        // if(onlyOnceExport && this.exports.length>1){
        //     onlyOnceExport.error(1192);
        // }
