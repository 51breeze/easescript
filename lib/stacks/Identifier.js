            ...
            if(_desc){
                if(this.parentStack.isMemberExpression && this.parentStack.object === this){
                    if(_desc.isDeclaratorVariable){
                        const type = _desc.type();
                        if(this.getObjectDescriptor(type, this.parentStack.property.value())){
                            return _desc;
                        }
                    }
                    ...
                    if(_desc.isDeclaratorFunction || _desc.isDeclaratorVariable || _desc.isModuleDeclaration){
                    ...
                    let object = null;
                    if(rawStack){
                        if(JSModule.is(rawStack.parentStack.module)){
                            object = rawStack.parentStack.module;
                        }
                    }else if(_desc.isNamespaceDeclaration){
