                ...
                if(global){
                    if(this.parentStack.isBinaryExpression && this.parentStack.isIsOperatorFlag && this.parentStack.right === this){
                        ...
                        if(!desc){
                            ...
                            if(desc && !this.compiler.options.service && this.compilation.isLocalDocument() && Namespace.dataset.imports.has(value)){
                                this.addImportSpecifierDependency(Namespace.dataset.imports.get(value))
                            }
