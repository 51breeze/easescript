                    ...
                    if(module){
                        if(!module.static){
                            ...
                            if(pp.isPropertyDefinition){
                                if(pp.static){
                                    this.scope.define("this",thisArgumentType || module);
                                }else{
                                    this.scope.define("this",thisArgumentType || new InstanceofType(module,this,null,true));
                                }
    ...
    normalization( type ){
        if( type && type.isUnionType ){
            if(type.elements.some( type=>{
                type = type.type();
                if(type && type.isComputeType)return false;
