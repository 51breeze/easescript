        ...
        if( _acceptType === void 0 && parent ){
            if( parent.isArrayPattern ){
                if( parent.acceptType && parent.acceptType.isTypeTupleDefinition ){
                    ...
                    _acceptType = this._acceptType = parent.acceptType.elements[index]||null;
                }
            }else if(parent.isProperty && parent.parentStack.isObjectPattern ){
                _acceptType = this._acceptType = parent.acceptType;
            }
        }
        return _acceptType;
    }
