...
class Declarator extends Stack{
    ...
    getRelateParamType(){
        return this.getAttribute('Declarator.getRelateParamType',()=>{
            ...
            const items = [];
            const paramType = declaredParam.isRestElement ? declaredParam.getItemType() : declaredParam.type();
    ...
    parser(){
        ...
        if( this.module && this.module.id === this.value() && !JSModule.is(this.module) ){
