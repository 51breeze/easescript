        ...
        if( this.source.isLiteral ){
            ...
            if(result){
                ...
                if(ns){
                    ...
                    result = ns.descriptors.get(property);
                    if(result){
                        this.importedModule = result[0];
                    }
                }
            }
        }
        ...
        if( desc ){
            ...
            if(!this.compiler.options.service && this.compilation.isLocalDocument()){
                ...
                if(ns && ns.imports.has(property)){
                    ...
                    this.addImportSpecifierDependency(ns.imports.get(property), desc, nameId)
                }
            }
