    ...
    type(){
        return this.getAttribute('CallExpression.type',()=>{
            ...
            if(type.hasGenericType){
                let res = Inference(this);
                if(res.toString() !== final.toString()){
                    console.log(type.toString(), '==>',  res.toString(), '==>', final.toString(), this.callee.raw(),   this.node.loc.start.line, this.file )
                }
            }
