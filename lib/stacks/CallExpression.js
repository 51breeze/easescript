...
class CallExpression extends Expression{
    ...
    type(){
        return this.getAttribute('CallExpression.type',()=>{
            ...
            // if(this.file && this.file.includes('test/GenericConstraint.es') && this.node.loc.start.line===11){
            //     console.log( final.toString() , "==================" , type.inherit.type().toString() , this.toString() )
            //     this.getInference().debug()
            // }
    ...
    parser(){
        ...
        if( length > 0 ){
            ...
            let inferContext = this.getContextOfInference();
            ...
            const checkArguments = (index, args, declareParams, declareTypes, top=false)=>{
                ...
                for(;index<args.length; index++){
                    ...
                    let inferCtx = inferContext.create(declareParamItem, acceptType)
