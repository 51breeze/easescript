                ...
                for(;index<args.length; index++){
                    ...
                    if( argument.isSpreadElement ){
                        ...
                        if(isRest || declareParamItem.isRestElement){
                            ...
                            if(acceptType && acceptType.hasGenericType){
                                let newV = this.getInference().apply(acceptType).toString()
                                let oldV = acceptType.toString(_ctx)
                                if(newV !== oldV ){
                                    console.log("call-->",acceptType.toString(),"-->", newV,"-->", oldV, "-->", this.file, "-->", this.node.loc.start.line,  "-->", this.callee.raw() )
                                }
                            }
