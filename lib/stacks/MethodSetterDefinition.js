...
class MethodSetterDefinition extends MethodDefinition{
    ...
    parser(){
        ...
        //const type = param.acceptType ? param.acceptType.type() : this.getGlobalTypeById("any");
        //let desc = this.compilation.getReference(this.key.value(), this.module, !!this.static , "get");
