...
declare Array<T=any> implements Iterator<T>, Iterable{
   ...
   */
   ...
   /**
     ...
     */
    reduce<V=T>(callbackfn: (previousValue: V, currentValue: T, currentIndex?: number, array?: T[]) => T, initialValue?: V): T;
     ...
     * @param initialValue If initialValue is specified, it is used as the initial value to start the accumulation. The first call to the callbackfn function provides this value as an argument instead of an array value.
     */
    reduceRight<V=T>(callbackfn: (previousValue: V, currentValue: T, currentIndex?: number, array?: T[]) => T, initialValue?: V): T;
...
declare class Event extends Object{
    ...
    static const SUBMIT:string;
    static const RESIZE:string;
    static const SELECT:string;
    static const UNLOAD:string;
    static const LOAD:string;
    static const LOAD_START:string;
    static const PROGRESS:string;
    static const RESET:string;
    static const FOCUS:string;
    static const BLUR:string;
    static const ERROR:string;
    static const COPY:string;
    static const BEFORECOPY:string;
    static const CUT:string;
    static const BEFORECUT:string;
    static const PASTE:string;
    static const BEFOREPASTE:string;
    ...
    static const TRANSITION_END:string;
    static isEvent(target:object):boolean;
