...
describe('test keyof type by test/Index.es > ', function() {
    ...
    it('compiler success', function(){
        ...
        expect('((()=>void) | (<T5, K6>(obj: T5, name: K6)=>T5[K6]) | (<T500, K600>(obj: T500, items: K600[])=>T500[K600][]))[]')
            .toBe( expression.type().toString() );
        expect('<T500, K600>(obj: T500, items: K600[])=>T500[K600][]').toBe( body[3].init.type().toString() );
