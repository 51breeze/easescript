...
declare module "tls" {
    ...
    interface TLSSocketOptions extends SecureContextOptions implements CommonConnectionOptions {
        /**
     ...
     * @since v0.11.4
     */
    declare class TLSSocket extends net.Socket {
        /**
    ...
    declare interface TlsOptions extends SecureContextOptions implements CommonConnectionOptions, net.ServerOpts {
        /**
    ...
    interface ConnectionOptions extends SecureContextOptions implements CommonConnectionOptions {
