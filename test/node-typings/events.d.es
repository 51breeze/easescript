...
declare module "events" {
    import { AsyncResource, AsyncResourceOptions } from "async_hooks";
    ...
    class EventEmitter extends NodeJS.EventEmitter {
         ...
         * objects.
         */
        static setMaxListeners(n?: number, ...eventTargets: (DOMEventTarget | NodeJS.EventEmitter)[]): void;
        /**
    ...
    namespace EventEmitter {
        ...
        export interface EventEmitterAsyncResourceOptions extends AsyncResourceOptions implements EventEmitterOptions {
            /**
         ...
         */
        export class EventEmitterAsyncResource extends NodeJS.EventEmitter {
            /**
