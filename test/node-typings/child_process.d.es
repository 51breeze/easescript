...
declare module "child_process" {
    ...
    declare type Serializable = string | object | number | boolean;
    declare type SendHandle = net.Socket | net.Server;
    /**
    ...
    interface CommonSpawnOptions extends CommonOptions implements MessagingOptions, Abortable {
    ...
    interface ExecFileOptions extends CommonOptions implements Abortable {
        maxBuffer?: number | undefined;
        killSignal?: NodeJS.Signals | number | undefined;
        windowsVerbatimArguments?: boolean | undefined;
        shell?: boolean | string | undefined;
    ...
    function execFile(file: string, args?: string[] | null): ChildProcess;
    function execFile(
        file: string,
    ...
    interface ForkOptions extends ProcessEnvOptions implements MessagingOptions, Abortable {
    ...
    function execFileSync(file: string, args?: string[], options?: ExecFileSyncOptions): string | Buffer;
