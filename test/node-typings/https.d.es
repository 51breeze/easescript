...
declare module "https" {
    ...
    type ServerOptions<
        ...
        Response extends http.ServerResponse<any>,
    ...
    interface AgentOptions extends http.AgentOptions implements tls.ConnectionOptions {
    ...
    > extends tls.Server {
        ...
        addListener(
            event: "connect",
            listener: (req: Request, socket: Duplex, head: Buffer) => void,
        ): this;
