...
declare module "http2" {
    ...
    export interface SecureClientSessionOptions extends ClientSessionOptions implements tls.ConnectionOptions {}
    export interface SecureServerSessionOptions extends ServerSessionOptions implements tls.TlsOptions {}
    ...
    export interface Http2Server extends net.Server implements HTTP2ServerCommon {
        addListener(
            event: "checkContinue",
    ...
    export interface Http2SecureServer extends tls.Server implements HTTP2ServerCommon {
        addListener(
            event: "checkContinue",
            listener: (request: Http2ServerRequest, response: Http2ServerResponse) => void,
        ): this;
