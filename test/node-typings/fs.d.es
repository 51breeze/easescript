...
declare module "fs" {
    ...
    export declare type PathOrFileDescriptor = PathLike | number;
    export declare type TimeLike = string | number | Date;
    export declare type NoParamCallback = (err: NodeJS.ErrnoException | null) => void;
    ...
    export declare type EncodingOption = ObjectEncodingOptions | BufferEncoding | undefined | null;
    ...
    export namespace symlink {
        ...
        declare type Type = "dir" | "file" | "junction";
    }
    /**
     * Returns `undefined`.
     *
    ...
    export interface BigIntStats extends StatsBase<number> {
        atimeNs: number;
        mtimeNs: number;
        ctimeNs: number;
        birthtimeNs: number;
