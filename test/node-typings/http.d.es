...
declare module "http" {
    ...
    type RequestListener<
        ...
        Response extends ServerResponse<IncomingMessage>,
    > = (req: Request, res: Response & { req: Request }) => void;
    /**
     * @since v0.1.17
     */
    class Server<
    ...
    > extends NetServer {
        ...
        addListener(
            event: "connect",
            listener: (req: Request, socket: stream.Duplex, head: Buffer) => void,
        ): this;
     ...
     * @since v0.1.17
     */
    class OutgoingMessage<Request extends IncomingMessage> extends stream.Writable {
     ...
     * @since v0.1.17
     */
    class ServerResponse<Request extends IncomingMessage> extends OutgoingMessage<Request> {
        /**
     ...
     * @since v0.1.17
     */
    class ClientRequest extends OutgoingMessage<any> {
        /**
    ...
    interface AgentOptions extends TcpSocketConnectOpts {
        /**
    ...
    function createServer<
        Request extends typeof IncomingMessage,
        Response extends typeof ServerResponse,
    >(options: ServerOptions<typeof IncomingMessage, typeof ServerResponse>, requestListener?: RequestListener<Request, Response>): Server<Request, Response>;
