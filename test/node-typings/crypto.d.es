...
declare module "crypto" {
    ...
    interface SignPrivateKeyInput extends PrivateKeyInput implements SigningOptions {}
    interface SignKeyObjectInput extends SigningOptions {
        key: KeyObject;
    }
    interface VerifyPublicKeyInput extends PublicKeyInput implements SigningOptions {}
    interface VerifyKeyObjectInput extends SigningOptions {
        key: KeyObject;
    }
    interface VerifyJsonWebKeyInput extends JsonWebKeyInput implements SigningOptions {}
    ...
    declare type DiffieHellmanGroup = DiffieHellman;
    /**
    ...
    class X509Certificate {
         ...
         */
        checkEmail(email: string, options?: any): string | undefined;
        /**
    ...
    namespace webcrypto {
        ...
        interface Crypto {
             ...
             * @since v15.0.0
             */
            getRandomValues<T extends NodeJS.TypedArray>(typedArray: T): T;
            /**
        ...
        interface SubtleCrypto {
            ...
            exportKey(format: any, key: CryptoKey): Promise<ArrayBuffer>;
            /**
