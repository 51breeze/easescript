...
declare module "readline" {
    ...
    declare type ReadLine = Interface; // type forwarded for backwards compatibility
    declare type Completer = (line: string) => CompleterResult;
    declare type AsyncCompleter = (line: string, callback: (err?: null | Error, result?: CompleterResult) => void) => void;
